...
export default function MBESessionPage({ params }: any) {
  ...
  const [reportedQuestions,setReportedQuestions] = useState<Record<number,boolean>>({})

  const [reportOpen,setReportOpen] = useState(false)
  const [reportText,setReportText] = useState("")

  const [eliminatedChoices,setEliminatedChoices] = useState<Record<number,string[]>>({})
  ...
  useEffect(()=>{
    ...
    async function loadSession(){
      ...
      try{
        ...
        setSessionMode(data?.mode ?? "study")
