...
import { Check, ChevronDown, CreditCard, FileText, Lock, Sparkles, X } from "lucide-react"
...
export function ManageBillingCard({
  ...
  return (
    <Card>
      <SectionHeader
        title={isPaid ? "Manage billing" : "Choose a plan"}
        right={
          <span className="text-[13px] font-medium text-slate-400">
            {isPaid ? "via Paddle customer portal" : "secure checkout by Paddle"}
          </span>
        }
      />
      ...
      {!isPaid ? (
        <>
          <BillingActionRow
            ...
            title="Choose BLL Monthly"
            subtitle="Unlock full Black Letter Law training"
            onClick={onChooseBLL}
          />
          ...
          <BillingActionRow
            ...
            subtitle="Unlock BLL plus premium rule tools"
